/**
 * Class BuyerInterfaceClientImplV1
 * Author: John Salame
...
public class BuyerInterfaceClientImplV1 implements BuyerInterface {

	private BuyerInterface transport; // transport layer for inter-process communication
	
	// CONSTRUCTORS
	public BuyerInterfaceClientImplV1() {}
	public BuyerInterfaceClientImplV1(BuyerInterface transport) {
